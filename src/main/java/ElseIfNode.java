public class ElseIfNode<T> extends Checkable<T> {
    private IBooleanFunc<T> condition = null;


    ElseIfNode(T data, Wrapper<Result> parentResult, IBooleanFunc<T> condition, ICallable<T>... functors) {
        super(data, parentResult, NodeType.ElseIfNode, functors);
